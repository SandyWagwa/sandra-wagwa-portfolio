      ...
      <div className="flex flex-col sm:flex-row justify-between gap-8">
        <div>
          ...
          <div className="socials flex flex-col gap-2 w-fit">
            <a href="tel:+254794566102"><span><FaPhoneAlt /></span> +254 798323729</a>
            <Link href="https://github.com/SandyWagwa" target="_blank">
              <span><FaGithub /></span> GitHub
            </Link>
            <Link href="https://www.linkedin.com/in/sandra-wagwa-52115229b/" target="_blank">
              <span><FaLinkedinIn /></span> LinkedIn
            </Link>
            <Link href="https://wa.me/+254798323729" target="_blank">
